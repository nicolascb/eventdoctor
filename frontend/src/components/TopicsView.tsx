                                                                    ...
                                                                    {eventProducers.length === 0 ? (
                                                                        ...
                                                                        <div className="flex flex-wrap gap-2">
                                                                            {eventProducers.slice(0, 3).map(p => (
                                                                                <div key={p.name} className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-muted/30 border border-border hover:bg-muted/50 transition-colors">
                                                                    ...
                                                                    {eventConsumers.length === 0 ? (
                                                                        ...
                                                                        <div className="flex flex-wrap gap-2">
                                                                            {eventConsumers.slice(0, 3).map(c => (
                                                                                <div key={c.group} className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-muted/30 border border-border hover:bg-muted/50 transition-colors">
                                                                                    <span className="text-xs text-foreground font-medium truncate max-w-[140px]">
                                                                                        {c.group}
                                                                                    </span>
                                                                                </div>
                                                                        ...
                                                                        {eventProducers.length > 0 ? (
                                                                            <div className="space-y-2">
                                                                                {eventProducers.map(p => (
                                                                                    <div key={p.name} className="p-4 bg-card rounded-lg border-2 border-border hover:border-primary/50 transition-colors flex flex-col gap-2">
